...
class DeepPriorNet(nn.Module):
    ...
    def __init__(self, block, num_classes=42,num_blocks=5,device=None):
        ...
        # fc1=nn.Linear(self.expected_fc_featurenum+3,1024) #option 1
        ...
        fc3=nn.Linear(1024+3,num_classes) #option 2
...
if __name__=="__main__":
    ...
    vrot = np.random.rand(batchsize,3)
        
    #model.train()
    model.eval()
    
    for i in range(1):
        rot = torch.FloatTensor(vrot)
        rot = rot.to(device)
