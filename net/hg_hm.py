...
class Residual(nn.Module):
    def __init__(self, numIn, numOut):
        ...
        self.numIn = numIn #256
        self.numOut = numOut #256
        self.bn = nn.BatchNorm2d(self.numIn)
        self.relu = nn.ReLU(inplace=True)
        self.conv1 = nn.Conv2d(self.numIn, self.numOut // 2, bias=True, kernel_size=1) #256, 128
...
if __name__ == '__main__':
    ...
    import numpy as np
    net_hm = Net_HM_HG(21, num_stages=2, num_modules=2, num_feats=256).cuda()
    summary(net_hm, (10,3,256,256))
